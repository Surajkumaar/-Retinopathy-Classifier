...
file_path = r"D:\archive (2)\dr_unified_v2\dr_unified_v1\train\balanced dataset\train_balanced_3000_with_dupes.csv"
df = pd.read_csv(file_path)
target_column = df.columns[1]
train_df, val_df = train_test_split(df, test_size=0.2, random_state=42, stratify=df[target_column])
train_csv_path = r"D:\archive (2)\dr_unified_v2\dr_unified_v1\train\balanced dataset\train.csv"
val_csv_path = r"D:\archive (2)\dr_unified_v2\dr_unified_v1\train\balanced dataset\val.csv"
